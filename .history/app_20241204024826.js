    ...
    try {
        ...
        if (existingSubmission) {
            ...
            requestAnimationFrame(() => {
                ...
                // Hide after 3 seconds with smooth fade
            ...
            newRefreshButton.addEventListener('mouseenter', () => {
                ...
                const existingWarning = document.querySelector('.existing-submission-warning');
                if (!existingWarning) {
                    const hoverWarning = warning.cloneNode(true);
                    headerControls.appendChild(hoverWarning);
                    requestAnimationFrame(() => {
                        hoverWarning.classList.add('show');
                    });
                }
            });
            ...
            newRefreshButton.addEventListener('mouseleave', () => {
                const existingWarning = document.querySelector('.existing-submission-warning');
                if (existingWarning) {
                    existingWarning.classList.add('fade-out');
                    existingWarning.classList.remove('show');
                    existingWarning.addEventListener('transitionend', () => {
                        if (!existingWarning.classList.contains('show')) {
