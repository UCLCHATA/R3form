...
// Function to display submission warning with animation
function displaySubmissionWarning(existingRow) {
    ...
    warning.className = 'existing-submission-warning show';
    warning.innerHTML = `
    ...
    submitWarning.className = 'submit-warning show';
    ...
    // Set up fade-out animation after 5 seconds
    setTimeout(() => {
    ...
    // Set up hover behavior to show warnings again
    const refreshButton = document.querySelector('.refresh-button');
    if (refreshButton) {
        refreshButton.classList.add('warning');
        ...
        // Hide warnings when not hovering
        refreshButton.addEventListener('mouseleave', () => {
            warning.classList.add('fade-out');
            submitWarning.classList.add('fade-out');
            setTimeout(() => {
                if (!refreshButton.matches(':hover')) {
