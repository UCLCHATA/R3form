...
async function handleRefreshClick(button, chataId) {
    try {
        // Add loading state
        ...
        // Recheck submission after refresh
        await checkExistingSubmission(chataId);
...
async function checkExistingSubmission(chataId) {
    try {
        ...
        newRefreshButton.addEventListener('click', () => handleRefreshClick(newRefreshButton, chataId));
