...
function hasSufficientCachedData() {
    try {
        ...
        return cachedData && Array.isArray(cachedData) && cachedData.length >= 2;
    } catch (error) {
...
// Function to load CHATA data with smart caching
