...
async function handleSubmit() {
    try {
        ...
        const formData = {
            ...
            Clinical_Observations: window.fieldContents['clinical-observations'] || '',
            Strengths_Abilities: window.fieldContents['strengths-abilities'] || '',
            Priority_Support: window.fieldContents['priority-support'] || '',
            ...
            Other_Referrals: window.fieldContents.referrals?.remarks || ''
        };
