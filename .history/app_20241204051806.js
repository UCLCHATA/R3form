...
function setupModalResize(modal) {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        // Constrain to form area width and viewport height
        const maxWidth = formArea.offsetWidth * 0.95;
        const maxHeight = window.innerHeight * 0.8;
        ...
        if (textarea && header) {
            ...
            textarea.style.height = `${modal.offsetHeight - headerHeight - 32}px`;
            textarea.style.width = `${modal.offsetWidth - 32}px`;
        }
    });
